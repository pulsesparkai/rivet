...
<p><strong>Open-source local AI agent. Runs on your machine. Your data stays yours.</strong></p>
...
<a href="https://github.com/pulsesparkai/rivet/pulls"><img src="https://img.shields.io/badge/PRs-welcome-brightgreen.svg" alt="PRs Welcome"></a>
<a href="https://www.npmjs.com/package/@pulsesparkai/rivet"><img src="https://img.shields.io/npm/v/@pulsesparkai/rivet.svg" alt="npm version"></a>
</p>
</div>
...
```bash
git clone https://github.com/pulsesparkai/rivet.git
cd rivet
pnpm install
pnpm build
```
