      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="https://github.com/pulsespark/rivet" className="text-sm text-gray-500 hover:text-gray-300 transition-colors">GitHub</a></li>
              <li><a href="https://github.com/pulsespark/rivet/issues" className="text-sm text-gray-500 hover:text-gray-300 transition-colors">Issues</a></li>
              <li><a href="https://github.com/pulsespark/rivet/discussions" className="text-sm text-gray-500 hover:text-gray-300 transition-colors">Discussions</a></li>
            </ul>
          </div>
        </div>
